...
public:
	...
	virtual ~SkeletonData() { nuitrack_DestroySkeletonTrackerData(_pimpl); }
	 ...
	 */
	int getNumSkeletons() const { return nuitrack_GetNumUsers(_pimpl); }
	 ...
	 */
	uint64_t getTimestamp() const { return nuitrack_GetSkeletonTrackerTimestamp(_pimpl); }
