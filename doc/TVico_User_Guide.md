...
_**Note:** you will need a **TVico license** to use TVico. The TVico license is a special form of the [Nuitrack Perpetual license](/doc/Licensing.md) and enables the [wireless use case](#wireless-case). The license key is sent to your mail after purchasing TVico on the [official website](https://tvico.io/)._
